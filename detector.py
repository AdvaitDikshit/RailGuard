...
SIZE_LARGE  = 0.15   # crack covers >15% of image → very large
SIZE_MEDIUM = 0.05   # crack covers 5-15% → medium
SIZE_SMALL  = 0.01   # crack covers 1-5% → small
# below 1% → hairline crack
    ...
    def detect(self, image_path: str) -> dict:
        ...
        if results.boxes is not None and len(results.boxes) > 0:
            ...
            for box, conf, cls_id in zip(boxes, confs, cls_ids):
                ...
                detections.append({
                    "class_id":   int(cls_id),
                    "class_name": names.get(cls_id, "crack"),
